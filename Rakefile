...
namespace :assets do
  Rake::SprocketsTask.new do |t|
    ...
    t.assets      = %w( application.js iframe-cache.js notifier.js application.css cupcake.png gears.png mentions.png profile.png search.png site_feed.png timeline.png )
